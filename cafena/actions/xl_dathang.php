    ...
    if ($query_order) {
        ...
        if ($payment == 'MOMO' || $payment == 'VNPAY') {
            ...
            if ($payment == 'MOMO') {
                ...
                $redirectUrl = "http://localhost:8080/cafena/views/main/thanhtoan/hoadon.php";
                $ipnUrl = "http://localhost:8080/cafena/views/main/thanhtoan/hoadon.php";
                $amount = $tongtien;
                $extraData = "";
                ...
                $vnp_Returnurl = "http://localhost:8080/cafena/views/main/thanhtoan/hoadon.php";
