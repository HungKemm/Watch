...
<table border="0" style="margin: 120px 20px 20px 100px; color: #fff; font-size: 1.6rem; width:85%; height: auto;">
    ...
    ?>
            <tr>
                ...
                <td style="text-align: center;">
                    <div class="soluong-sp-dem" style="background-color: #fff;  font-size:16px;border: 2px solid green;  width: 60%; margin: 0 auto; display:flex">
                        ...
                        <input style="width: 35px;padding: 3px 10px; border: 0.1px solid green;" type="text" name="soluong" value="<?php echo $cart_item['soluong'] ?>">
