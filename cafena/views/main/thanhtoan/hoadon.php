...
<body>
    ...
    $kn = mysqli_connect("localhost", "root", "", "coffees");
    if (!$kn) {
        echo "Lỗi kết nối";
    }
    session_start();
                    ...
                    <div class="ticket bg-white p-5" id="ticket">
                        <div class="row d-flex justify-content-between">
                            <div class="col-12 d-flex">
                                <img src="/cafena/images/a4.png" style="width: 60px;" alt="">
                                <span class="ms-2 mt-3"><b>DHWatch</b></span>
                            </div>
                            <div class="col-12 mt-2">
                                <span class="row">Địa chỉ: Số 22, Ngõ 136, Đường Cầu Diễn, Bắc Từ Liêm, Hà Nội, Việt Nam</span>
                                <span class="row">Số điện thoại: 0398958692</span>
                            </div>
                        ...
                        <div class="row my-5 d-flex justify-content-between">
                            <div class="col-5">
                                ...
                                <div class="d-flex justify-content-center">Trần Duy Hưng</div>
                            </div>
                            <div class="col-5">
