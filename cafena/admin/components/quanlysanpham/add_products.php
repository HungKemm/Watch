		        ...
		        <div class="card">
		            <div class="card-body">
                        <form action="../actions/them_product.php" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3 row">
                                <label for="dangdouong" class="col-sm-3 col-form-label fw-bold">Danh mục</label>
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control"
                                        id="dangdouong"
                                        ...
                                        required>
                                    <div class="invalid-feedback">
                                        Hãy nhập danh mục sản phẩm
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="loaithucpham" class="col-sm-3 col-form-label fw-bold">Thông số</label>
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control"
                                        id="loaithucpham"
                                        ...
                                        required>
                                    <div class="invalid-feedback">
                                        Hãy nhập thông số kĩ thuật
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="hansudung" class="col-sm-3 col-form-label fw-bold">Bảo hành</label>
                                <div class="col-sm-9">
                                    <input type="text"
                                        class="form-control"
                                        id="hansudung"
